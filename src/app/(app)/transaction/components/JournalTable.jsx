...
const JournalTable = ({
    ...
    return (
        <div className="">
            ...
            <div className="relative w-full sm:max-w-sm ml-4 my-2">
                ...
                <input
                    ...
                    placeholder="Search..."
                    className="block w-full text-sm mb-2 pl-10 pr-4 py-2 text-gray-900 placeholder-gray-400 bg-white border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
            </div>
                                ...
                                <tr key={journal.id} className="group hover:bg-slate-600 hover:text-white">
                                    <td className="whitespace-normal">
                                        ...
                                        <span
                                            ...
                                            hidden={!journal.finance?.contact?.name}
                                        >
                                            Contact: {journal.finance?.contact?.name}
                                        </span>
