...
const CreateJournal = ({ isModalOpen, notification, fetchJournalsByWarehouse, today }) => {
            ...
            <div className="mb-2 grid grid-cols-1 sm:grid-cols-3 sm:gap-4 items-center">
                ...
                <div className="col-span-1 sm:col-span-2">
                    <select
                        ...
                        className="w-full rounded-md border p-2 text-xs sm:text-sm shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 disabled:bg-slate-200 disabled:cursor-not-allowed disabled:text-slate-400"
