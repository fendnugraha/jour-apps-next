...
const OrderDetail = ({ invoice }) => {
    ...
    const deleteItem = async (id, selectedProduct) => {
        try {
            const response = await axios.delete(`/api/delete-trx-item/${id}`, {
                params: {
                                            ...
                                            <Dropdown align="left" trigger={<EllipsisIcon className="w-4 h-4" />}>
                                                <ul>
                                                    ...
                                                    <li>
                                                        <button
                                                            onClick={() => {
                                                                deleteItem(order.id, item.product?.id);
                                                            }}
                                                            className="text-start px-2 py-1 min-w-20 text-red-500 hover:underline hover:bg-slate-200"
                                                        >
                                                            Hapus
                                                        </button>
                                                    </li>
